...
<template>
  <div class="relative min-w-64 rounded-md border-2 border-secondary bg-primary px-4 py-2">
    <p class="whitespace-nowrap rounded text-2xl font-bold text-white drop-shadow-md first-letter:uppercase">{{ programDay }}</p>
    <div class="mt-2 text-lg text-neutral-50">
